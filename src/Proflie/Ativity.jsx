        ...
        <div className='container max-w-[1320px] mx-auto py-6 px-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 my-6'>
                ...
                <div className='bg-pink-300 rounded-xl p-6 shadow-2xl shadow-black/80'>
                    <h3 className='text-white text-[1.1rem] md:text-[2.25rem] font-semibold'>กิจกรรมกิฬาสี ประจำปีการศึกษา 2567</h3>
                    <p className='mt-2 text-[1rem]'><span className='text-[1.25rem] font-semibold'>-</span>ได้เป็นตัวแทนในการถือพานพุ่มที่กิจกรรมกีฬาสี </p>
                </div>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div className='bg-pink-300 rounded-xl p-6 my-4 shadow-2xl shadow-black/80 '>
                    ...
                    <p className='mt-2 text-[1rem]'><span className='text-[1.25rem] font-semibold'>-</span>ได้เป็นตัวแทนในการเปิดพิธีและได้ถือธงสาขาคอมพิวเตอร์ธุรกิจ</p>
                </div>
