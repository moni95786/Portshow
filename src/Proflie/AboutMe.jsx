    ...
    <div className='bg-cyan-100' id='aboutMe'>
      <div className='container max-w-[1320px] mx-auto p-4 md:p-5'>
        <div className='bg-gray-700 text-white rounded-xl p-4 shadow-2xl shadow-black/40'>
          ...
          <p className='mt-3 text-[1rem] md:text-[1.15rem] leading-relaxed'>สวัสดีครับ ผมชื่อมอน ผมมีความสนใจในด้านโปรแกรมเมอร์ตั้งแต่ผมอยู่ ม.3 โดยเริ่มเขียนครั้งแรกโดยใช้ภาษา Python ซึ่งเป็นภาษาที่เข้าใจง่ายและไม่ยากเลยทำให้ชอบการเขียนโค้ดเรื่อยมา <br />
             หลังจากขึ้น ปวช.1 ก็สนใจอยากทำเว็บไซต์ขึ้นมาจึงศึกษาด้วยตัวเองและมีเพื่อนที่ค่อยช่วยในการให้คำปรึกษาทำให้เรีนนรู้การเขียนเว็บไซต์เบื้องต้นมา<br />
